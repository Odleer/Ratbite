...
uplink-chest-rig-name = Тактический жилет
...
uplink-knives-kit-name = Набор метательлных ножей
...
uplink-clothing-outer-vest-web-name = Армейская ременно-плечевая система
