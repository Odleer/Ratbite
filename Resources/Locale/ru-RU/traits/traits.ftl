...
trait-description-NaniteAutoRepairBots = Your chassis has been outfitted with Nanite Repair Drones. Whenever your sensors detect that you've recieved structural damage, the NRDs will activate to bring you back to operational standards.
...
trait-wheelchair-bound-name = Привязанность к креслу каталке
trait-wheelchair-bound-desc = Вы не можете перемещаться самостоятельно. Кресло-каталка идёт в комплекте.
...
trait-colorblindness-desc = У вас протанопия. Вы не можете различать цвета и оттенки цветов в спектре пурпурного цвета.
trait-tall-name = Дылда
trait-tall-desc = У вас проблемы с гигантизмом.
trait-short-name = Коротышка
...
trait-pious-name = Благочестивый
trait-pious-desc = Ты находишься в общении с божествами, но твои клятвы удерживают тебя от яростных действий.
trait-streetpunk-accent-name = Акцент уличного панка
trait-streetpunk-accent-desc = Ты родился в огромном мегаполисе и никогда не ходил в школу. И это заметно, чел.
trait-deuteranopia-name = Дейтеранопия
trait-deuteranopia-desc = Будь то из-за специальных бионических глаз, случайной мутации или из-за того, что вы вулпканин, у вас красно-зеленая дальтонизм.
